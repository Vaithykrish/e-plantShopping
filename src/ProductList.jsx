...
function ProductList({ onHomeClick }) {
    ...
    // Get cart items from Redux to check which plants are already added
    ...
    const plantsArray = [
        ...
        // ... You can add the other categories here from your previous data
    ];
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '1100px'}}>
                    <div> <a href="#" onClick={(e) => {e.preventDefault(); setShowCart(false);}} style={styleA}>Plants</a></div>
                    <div> 
                        <a href="#" onClick={(e) => {e.preventDefault(); setShowCart(true);}} style={styleA}>
                            <h1 className='cart'>
                                <div style={{position: 'relative'}}>
                                    ...
                                    {totalCartQuantity > 0 && (
                                        <span className="cart-quantity-count">{totalCartQuantity}</span>
                                    )}
                                </div>
                            </h1>
                        </a>
